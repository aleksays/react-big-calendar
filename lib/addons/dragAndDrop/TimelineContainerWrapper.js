...
var TimelineContainerWrapper =
  /*#__PURE__*/
  (function(_React$Component) {
    ;(0, _inheritsLoose2.default)(TimelineContainerWrapper, _React$Component)

    function TimelineContainerWrapper() {
      var _this
      ...
      _this.handleMove = function(point, boundaryBox) {
        ...
        var currentSlot = slotMetrics.closestSlotFromPointHr(
          {
            x: point.x,
          },
          boundaryBox
      ...
      _this._selectable = function() {
        ...
        var selector = (_this._selector = new _Selection.default(function() {
          return node.closest('.rbc-time-row')
        }))
    ...
    var _proto = TimelineContainerWrapper.prototype
    ...
    _proto.handleResize = function handleResize(point, boundaryBox) {
      ...
      var currentSlot = slotMetrics.closestSlotFromPointHr(point, boundaryBox)
    ...
    _proto.render = function render() {
      ...
      return _react.default.cloneElement(children, {
        children: _react.default.createElement(
          ...
          events,
          event &&
            _react.default.createElement(_TimelineEvent.default, {
              event: event,
              label: label,
    ...
    return TimelineContainerWrapper
