...
var TimelineEventWrapper = /*#__PURE__*/ (function(_React$Component) {
  ;(0, _inheritsLoose2.default)(TimelineEventWrapper, _React$Component)
  ...
  var _proto = TimelineEventWrapper.prototype
  ...
  _proto.render = function render() {
    ...
    if (isResizable || isDraggable) {
      ...
      if (isResizable) {
        ...
        var StartAnchor = this.renderAnchor('Left')
        var EndAnchor = this.renderAnchor('Right')
