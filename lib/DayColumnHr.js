  ...
  (function(_React$Component) {
    ...
    function DayColumn() {
      ...
      _this.renderEvents = function() {
        ...
        return styledEvents.map(function(_ref, idx) {
          ...
          return _react.default.createElement(_TimelineEvent.default, {
            style: style,
            event: event,
            label: label,
            key: 'evt_' + idx,
      ...
      _this._selectable = function() {
        ...
        var selectionState = function selectionState(point) {
          var currentSlot = _this.slotMetrics.closestSlotFromPointHr(
            point,
    ...
    _proto.positionTimeIndicator = function positionTimeIndicator() {
      ...
      if (current >= min && current <= max) {
        var top = this.slotMetrics.getCurrentTimePositionHr(current)
    ...
    _proto.render = function render() {
      var _this$props3 = this.props,
        ...
        alldayEvents = _this$props3.alldayEvents,
        id = _this$props3.id,
        ...
        TimelineContainerWrapper =
          _this$props3$componen.timelineContainerWrapper,
      ...
      var groupedEvents = resources.groupEvents(alldayEvents)
      return _react.default.createElement(
        ...
        _react.default.createElement(
          'div',
          {
            className: 'rbc-time-row rbc-time-row--hr rbc-time-row--allday',
          },
        ...
        _react.default.createElement(
          ...
          slotMetrics.groups.map(function(grp, idx) {
            return _react.default.createElement(_TimeSlotGroupHr.default, {
              key: idx,
              group: grp,
              resource: resource,
              getters: getters,
